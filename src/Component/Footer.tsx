        ...
        <footer className="bg-black text-gray-400 py-12">
            <div className=" max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-2 sm:px-4 lg:px-6 ">
                <div>
                    ...
                    <p className="py-4 ">Music School is a premier institution dedicated to teaching the art and science of music.We nurture talent from the ground up,fostering a vibrant community of musicians. </p>
                ...
                <div>
                    ...
                    <div className=" py-4">
                     ...
                     <p>Dhaka-1216</p>
                     <p>Email:mosayebhossain09@gmail.com</p>
                     <p>Phone:01621318409</p>
                    </div>
